...
<header class="top">
    ...
    <div class="tong">
        <div class="giua">
            <div class="chitiet">
                <img src="..\images\image_179484.jpg" alt="" class="imgProduct" width="50%"height="50%">
                <div class="ctsp">
                    <h2>Sách Hai Số Phận</h2>
                    <div class="Giatien">150.000đ</div>
                    <div class="box">
                        <div class="muahang">
