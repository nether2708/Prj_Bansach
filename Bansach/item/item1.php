...
<header class="top">
    ...
    <div class="tong">
        <div class="giua">
            <div class="chitiet">
                <img src="..\images\1-166805376098477201452.jpg" alt="" class="imgProduct" width="50%"height="50%">
                <div class="ctsp">
                    <h2>Sách Cristiano Ronando</h2>
                    <div class="Giatien">100.000đ</div>
                    <div class="box">
                        <div class="muahang">
